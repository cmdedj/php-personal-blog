...
<div class="container-fluid">
    <div class="row">
        ...
        <form name="form" method="post" action="article.modify.handle.php">
         <input name="id" type="hidden" value="<?php echo $data['id']?>">
        <p>标题</p><input name="title" type="text" value="<?php echo $data['title']?>" />
        <p>作者</p><input name="author" type="text" value="<?php echo $data['author']?>" />
            <p>简介</p><textarea name="description" cols="60" rows="5"><?php echo $data['description']?></textarea>
            <p>内容</p>
            <script name="content" id="editor" type="text/plain" style="width:800px;height:600px;"><?php echo $data['content']?></script>
