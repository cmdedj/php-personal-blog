...
if(!isset($_SESSION['test']))
{
    ...
    $sql = "select* from comment order by dateline desc";
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li>Comment</a></li>
                <li  class="active"><a href="#">CommentManagement</a></li>
            </ul>
        </div>
                    ...
                    if(!empty($data)) {
						foreach ($data as $value) {
                            ...
                            <tr>
                                ...
                                <td width="20%"><?php echo $value["articlename"] ?></td>
                                ...
                                <td width="10"><a href="comment.del.handle.php?id=<?php echo $value["id"] ?>">删除</a></td>
                            </tr>
							<?php
						}
					}
